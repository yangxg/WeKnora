...
const (
	...
	DocReader_GetRuntimeInfo_FullMethodName = "/docreader.DocReader/GetRuntimeInfo"
)
...
type DocReaderClient interface {
	...
	GetRuntimeInfo(ctx context.Context, in *RuntimeInfoRequest, opts ...grpc.CallOption) (*RuntimeInfoResponse, error)
}
...
func (c *docReaderClient) GetRuntimeInfo(ctx context.Context, in *RuntimeInfoRequest, opts ...grpc.CallOption) (*RuntimeInfoResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RuntimeInfoResponse)
	err := c.cc.Invoke(ctx, DocReader_GetRuntimeInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedDocReaderServer) GetRuntimeInfo(context.Context, *RuntimeInfoRequest) (*RuntimeInfoResponse, error) {
...
func _DocReader_GetRuntimeInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RuntimeInfoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DocReaderServer).GetRuntimeInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DocReader_GetRuntimeInfo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DocReaderServer).GetRuntimeInfo(ctx, req.(*RuntimeInfoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DocReader_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _DocReader_GetRuntimeInfo_Handler,
		},
	},
